...
function addBillItem() {
    ...
    itemRow.innerHTML = `
        ...
        <div class="col-md-2">
            <input type="number" class="form-control item-quantity" value="1" min="1" onchange="updateItemTotal(this)">
        </div>
        <div class="col-md-3">
    ...
    try {
        ...
        if (createBillModal) {
            createBillModal.addEventListener('show.bs.modal', () => {
                ...
                addBillItem(); // Add first item row
            });
        }
...
// Add these functions for viewing and editing bills
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer no-print">
                            ...
                            ` : ''}
                            <button type="button" class="btn btn-info" onclick="printBill('${bill.id}')">
                                <i class="fas fa-print"></i> Print
                            </button>
                            <button type="button" class="btn btn-primary" onclick="editBill('${bill.id}')">
